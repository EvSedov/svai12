...
const isLargeScreen = ref(import.meta.client ? window.innerWidth >= 1920 : false);
    ...
    >
        ...
        >
            ...
            >
                ...
                <Button
                    class="mx-auto h-15 rounded-full bg-[#FF8D00] px-9 py-0 text-lg font-semibold text-white uppercase shadow-lg transition-all duration-300 hover:bg-[#B16303] xl:mx-0"
