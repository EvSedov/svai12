...
<template>
    ...
    >
        ...
        <h3 class="mb-6 font-montserrat text-8 leading-snug font-semibold tracking-[0.02em] text-black/75">
            {{ props.title }}
        </h3>

        <p class="mb-5 text-5.5 leading-none font-medium tracking-[0.02em] text-black/65">
            {{ props.thickness }}
        </p>
