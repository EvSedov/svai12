...
function getIcon(type: string) {
    switch (type) {
        case "success":
            return resolveComponent("IconsCheckCircleIcon");
        case "warning":
            return resolveComponent("IconsExclamationTriangleIcon");
        case "error":
            return resolveComponent("IconsXCircleIcon");
        case "info":
            return resolveComponent("IconsInformationCircleIcon");
        default:
            return resolveComponent("IconsInformationCircleIcon");
    }
}
